...
**Joy Wing Mau outperforms VX Logistics in terms of secondary packout and total yield**
...
-   Mechanical defects (at secondary packout stage): Sunfruit **19.28%** vs Te Ipu **13.71%**
...
Given that all of the orginal consignment of MB format fruit was packed at Te Ipu a more valid comparison of defect profile would be against only fruit that was orginaly packed at Te Ipu.[^inmarketpackingqualityreport-1] Given this is a convenient analysis to perform it is presented in @fig-MBvsEXPForTI.

[^inmarketpackingqualityreport-1]: Packing site is one of a number of variables that are expected to have an impact on the in-market packing performance.
...
In addition to the transit pack format trials, discussions are underway with Plant & Food and Massey University to look at characterising the mechanical strength (in terms of Young's modulus) of the Rockit™ apple using apparatus and methodology developed for the Kiwifruit industry. Preliminary (proof of concept) experiments are being planned for 2025.
